...
class StableDiffusionXLImg2ImgReferencePipeline(
    DiffusionPipeline,
    ...
    # copied from stable_diffusion_xl_reference.py
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # Copied heavily from stable_diffusion_xl_reference.py
        ...
        if reference_adain:
            ...
            for i, module in enumerate(gn_modules):
                ...
                module.var_bank = []
                module.gn_weight *= 2
        # End heavily copied from stable_diffusion_xl_reference.py
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # end of copied from stable_diffusion_xl_reference.py
